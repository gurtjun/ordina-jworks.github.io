...
[<img class="image fit" style="margin:0px auto; max-width: 300px;" alt="Kafka Streams Topology" src="streams-architecture-topology.jpg">](https://kafka.apache.org/11/documentation/streams/core-concepts#streams_topology){:target="_blank" rel="noopener noreferrer"}
...
<img class="image fit" style="margin:0px auto; max-width: 500px;" alt="Tumbling Window" src="streams-time-windows-tumbling.png">
...
<img class="image fit" style="margin:0px auto; max-width: 500px;" alt="Hopping Window" src="streams-time-windows-hopping.png">
...
<img class="image fit" style="margin:0px auto; max-width: 500px;" alt="Session Window" src="streams-session-windows-02.png">
